...
const scenes = [
  { title:'THE DAY AFTER', text:[
    ...
    `You wake before your alarm. For a few seconds, you don't know why. Then you remember the crack in the street. The light. The symbol. The man who told you not to move closer.`,
  ...
  { title:'THE PHONE', text:[
    ...
    'The screenshot was posted at 2:13 A.M.',
    `You don't know why that bothers you. Maybe because you were awake at 2:13.`
  ...
  { title:'THE WALK TO SCHOOL', text:[
    ...
    `Not because the streets changed. They didn't. Because now you are looking for things you used to ignore.`,
    `A maintenance truck is parked beside a storm drain. Two workers are talking quietly. One points toward the pavement and the other stops talking when they notice you.`,
    'A newspaper stand is displaying three different versions of the same story.',
  ...
  { title:'SCHOOL — FIRST PERIOD', text:[
    `The classroom is louder than usual. Everyone is talking about yesterday.`,
  ...
  { title:'THE HALLWAY', text:[
    ...
    'You place your hand against it. Warm.',
    'The humming stops.',
    'Someone speaks behind you.',
    '“You shouldn’t be here.”',
    'You turn. It is the same older man from yesterday.'
  ...
  { title:'THE STRANGER', text:[
    ...
    '“The light.”',
    `Your stomach tightens. He glances toward the utility door.`,
    '“Some things in this city are older than the streets built around them.”',
    'You ask him what the symbol means.',
    '“Forget the symbol.”',
    'Then he walks away.',
    'Before he disappears, he adds one more thing:',
    '“Whatever you do, don’t follow the blue light.”'
  ], choices:['Follow him.','Open the utility door after he leaves.','Return to class.'] },
  { title:'LUNCH', text:[
    `By lunch, you've heard three different stories about the stranger. None of them make sense.`,
    `You sit with your food while the conversation around you shifts from the incident to normal teenage complaints.`,
    'Then someone mentions a power outage from the night before.',
  ...
  { title:'AFTER SCHOOL — THE DETOUR', text:[
    `When school ends, you don't go straight home. Not yet.`,
    'The crack is still on your mind.',
    'You head toward the city center.',
    `Paris is busy, but something is strange about the atmosphere. People keep checking their phones. Police cars pass through intersections. A helicopter circles somewhere in the distance.`,
  ...
  { title:'THE FIRST CHOICE THAT MATTERS', text:[
    'This is not a choice that changes the story. Not yet.',
  ...
  { title:'THE BOOKSTORE', text:[
    `You remember an old bookstore a few blocks away. If there is anything in this city that might explain a symbol like this, maybe it is there.`,
    'The shop is cramped and quiet. The owner is an older woman with silver glasses.',
  ...
  { title:'THE NOTE', text:[
    ...
    'No explanation.',
    'You look up. She is already reading again.',
  ...
  { title:'THE FOLLOWER', text:[
    ...
    'You start again. They start again.',
  ...
  { title:'THE SERVICE ENTRANCE', text:[
    ...
    'No numbers. No words. Only the same symbol.',
    'You touch it.',
    'Click.',
    'The door unlocks.'
  ], choices:['Open the door.','Leave and come back later.','Call someone before entering.'] },
  { title:'BELOW PARIS', text:[
    `The stairway descends farther than it should. The city noise disappears behind you.`,
    'No traffic. No voices. No sirens.',
    'Just your footsteps.',
    'The walls are old brick at first. Then stone. Then something else.',
  ...
  { title:'THE FIRST DOOR', text:[
    ...
    'Not words. A sound like someone breathing on the other side.'
  ], choices:['Press harder.','Step back.','Speak to whoever is there.'] },
  { title:'SOMETHING ANSWERS', text:[
    'The stone door shifts. Just an inch.',
  ...
  { title:'THE WARNING', text:[
    'The message has no sender. No number. No icon.',
    'Just one sentence:',
  ...
  { title:'EVENING', text:[
    'You go home.',
    'You eat. You answer a few questions. You try to act normal.',
  ...
  { title:'END OF THE FIRST HOUR', text:[
    ...
    'Tomorrow will answer some of those questions. But not all of them.',
...
document.querySelectorAll('.side-menu button').forEach(b=>b.onclick=()=>{
  ...
  if(p==='kwami-book') openSide('Kwami Book','<h3>Kwami Book</h3><p>No Kwamis discovered yet.</p><p>Each discovered Kwami will appear here with its Miraculous, weapon, abilities, and known information.</p>');
  if(p==='skill-tree') openSide('Skill Tree','<h3>Skill Tree</h3><p>Locked.</p><p>The tree activates when you obtain your first Miraculous.</p><p>Each level awards 3 permanent Skill Points. You can spend them on the tree, physical traits, or save them.</p>');
  if(p==='quest-book') openSide('Quest Book','<h3>Quest Book</h3><p>No quests are available yet.</p><p>Quests will appear later. Rewards are only shown when intended by the story.</p>');
});

function phone(tab){
  let html='';
  if(tab==='texts') html='<h3>Text App</h3><p>No new messages.</p><p class="muted">New conversations will appear naturally.</p>';
  ...
  if(tab==='music') html='<h3>Music</h3><ol><li>Paris at Dawn</li><li>Quiet Streets</li><li>Something Beneath</li><li>Chasing the Unknown</li><li>Midnight Signal</li></ol><p class="muted">Original in-game music slots; no copyrighted recordings are used.</p>';
